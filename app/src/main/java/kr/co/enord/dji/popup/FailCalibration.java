...
public class FailCalibration extends ConstraintLayout implements View.OnClickListener{
    public FailCalibration(Context context, int calibration_type) {
        super(context);
