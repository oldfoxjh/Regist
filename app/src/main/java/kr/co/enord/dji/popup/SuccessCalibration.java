...
public class SuccessCalibration extends ConstraintLayout implements View.OnClickListener{
    public SuccessCalibration(Context context, int calibration_type) {
        super(context);
